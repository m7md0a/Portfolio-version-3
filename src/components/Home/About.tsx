        ...
        <motion.div animate={{opacity: 1}} className="mb-28 max-w-[45rem] text-center leading-8 opacity-0">
            ...
            <figure className="max-w-screen-md mx-auto text-center">
                ...
                <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
                    <img className="w-6 h-6 rounded-full" src="http://localhost:3000/_next/image?url=https%3A%2F%2Favatars.githubusercontent.com%2Fu%2F54208900%3Fv%3D4&w=384&q=75" alt="profile picture" />
                    <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500 dark:divide-gray-700">
                        <cite className="pe-3 font-medium text-gray-900 dark:text-white">Mohamed Abdelrahman</cite>
                        <cite className="ps-3 text-sm text-gray-500 dark:text-gray-400">Front end</cite>
                    </div>
                </figcaption>
            </figure>
