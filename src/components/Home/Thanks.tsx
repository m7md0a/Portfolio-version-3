...
export default function Thanks() {
  return (
    <ContainerApp className="max-w-5xl mx-auto px-8 min-h-[80vh] flex items-center">
      <div>
        <div className="grow flex flex-col items-center w-full">
          ...
          <div className="flex justify-between flex-wrap w-full md:w-3/5 [&>a>svg]:w-9 [&>a>svg]:h-9 md:[&>a>svg]:w-12 md:[&>a>svg]:h-12 text-blue-800">
            ...
            <a
              href="https://linkedin.com/in/m7md0a"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              href="https://twitter.com/m7md_0a"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              href="https://www.instagram.com/m7md_0a/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
